const images = [
  'collage.png','24133.jpg','24134.jpg','24135.jpg','24136.jpg','24137.jpg','24138.jpg','24139.jpg','24140.jpg','24141.jpg','24142.jpg','24143.jpg','24144.jpg','24145.jpg','24146.jpg','24148.jpg','24149.jpg','24150.jpg','24151.jpg','24152.jpg','24153.jpg','24154.jpg','24155.jpg','24156.jpg','24158.jpg'
];
...
function checkPass(){
  ...
  else document.getElementById('err').textContent = 'Wrong password 😭 try 2906 vibes only!';
}
...
function renderBirthday(){
  app.innerHTML = `<section class="screen"><div class="card hero">
    ...
    <img class="collage" src="assets/collage.png" alt="Birthday Collage">
  </div></section>
  <section id="memories" class="screen"><div class="card">
    ...
    <div class="gallery">${images.map((img,idx)=>`<div class="photo" style="--r:${[-2,1.5,-1,2,0][idx%5]}deg"><img src="assets/${img}" alt="memory"></div>`).join('')}</div>
...
function confetti(){
  ...
  let pieces = Array.from({length:120},()=>({x:Math.random()*c.width,y:-20-Math.random()*c.height,r:Math.random()*6+3,s:Math.random()*3+2,a:Math.random()*Math.PI*2}));
  let t=0;
  function draw(){
    ctx.clearRect(0,0,c.width,c.height);
    pieces.forEach(p=>{p.y+=p.s;p.x+=Math.sin(p.a+t/20);ctx.fillStyle=['#ff5ea8','#ffc15a','#b46cff','#ff8c5a'][Math.floor(Math.random()*4)];ctx.beginPath();ctx.arc(p.x,p.y,p.r,0,Math.PI*2);ctx.fill();});
    t++;
